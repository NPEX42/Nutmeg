...
import uk.co.np.nutmeg.IO;
public class Shader {
	private int programID, vertexID, fragmentID;
	private Map<String, Integer> uniforms;
	private Shader(int _ProgramID, int _VertexID, int _FragmentID) {
	...
	public static Shader CompileShader(String _VertexSource, String _FragmentSource) {
		...
		if(glGetProgrami(programID, GL_LINK_STATUS) == GL_FALSE) {
			...
			System.err.println(glGetProgramInfoLog(fragmentID));
			System.err.println("===============================");
			return null;
		}
	...
	public static Shader LoadShader(String _VertexPath, String _FragmentPath) {
	...
	private static Shader LoadJAR(String _VertexPath, String _FragmentPath) {
